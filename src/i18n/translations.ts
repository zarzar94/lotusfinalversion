...
export const translations = {
  ...
  en: {
    ...
    frequency: {
      objective: 'Adaptive 2IFC',
      instructions: 'Listen to two tones and choose which interval had the higher pitch. The difference adapts based on your answers.',
      ...
      intervalOne: 'Interval 1',
      intervalTwo: 'Interval 2',
      playPrompt: 'Press play to hear the tones.',
      playTones: 'Play tones',
      whichHigher: 'Which interval had the higher pitch?',
      choiceFirst: 'First tone',
      choiceSecond: 'Second tone',
      adaptiveHint: 'The difficulty adapts based on your answers.',
      summaryTitle: 'Frequency discrimination complete',
      summaryHigh: 'Strong tone discrimination in this screening snapshot.',
      summaryMid: 'Moderate discrimination with room to refine.',
      summaryLow: 'Lower discrimination detected; consider repeating in a quiet setting.',
      note: 'Threshold here is a screening estimate (no normative calibration).',
    },
    ...
    sequence: {
      ...
      objective: 'Working memory sequencing',
      instructions: 'Listen to the sequence and tap the shapes in the same order.',
      instructionsEmphasis: 'Focus on the order you hear.',
      instructionsSuffix: 'Practice first, then the adaptive test begins.',
      startPractice: 'Start Practice',
      practiceLabel: 'Practice',
      roundLabel: 'Round',
      ...
      listeningTitle: 'Listen to the sequence',
      listeningBody: 'Focus on the order. You will tap the shapes next.',
      progressLabel: 'Selections',
      scoreLabel: 'Score',
      replayLabel: 'Replay sequence',
      feedbackCorrect: 'Correct!',
      feedbackIncorrect: 'Try again',
      noReplayBonus: 'No replay bonus',
      reminderTitle: 'Remember the order',
      reminderBody: 'Tap the shapes in the same order you heard them.',
      doneTitle: 'Sequence complete',
      doneBody: 'Download the session details for review.',
      reportTitle: 'Sequence Demo Report',
      reportDisclaimer: 'This export is a non-diagnostic screening summary.',
      spanLabel: 'Span',
      replayPolicy: 'one replay max per round',
      note: 'Span is a screening estimate (non-diagnostic).',
      summaryHigh: 'Strong sequencing performance in this screening snapshot.',
      summaryMid: 'Moderate sequencing with room to strengthen working memory.',
      summaryLow: 'Lower sequencing accuracy; consider repeating in a quiet setting.',
    },
    ...
    dashboard: {
      ...
      trendNeedsMore: 'Complete more sessions to see trend insights.',
