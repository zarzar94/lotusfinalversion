...
export const BRAIN_FUNCTIONS: BrainFunction[] = [
  {
    ...
    contentAr: {
      ...
      subtitle: 'كيف نعالج الأصوات ونفسرها',
      questions: [
        'أحيانًا يبدو أن الجهاز السمعي غير متوازن؛ هناك شيء غير مضبوط لكن من الصعب تحديده بدقة.',
        'قد تبدو الأصوات عالية جدًا أو مؤلمة، وقد تبدو الكلمات مشوّهة أو سريعة جدًا بحيث تختلط، مما يجعل تمييزها صعبًا.',
        'الضوضاء الخلفية في المطاعم أو الأماكن المزدحمة تشتّت وتربك المحادثة.',
      ],
      explanation: 'هذه الصعوبات تتداخل مع المعالجة السمعية وتجعل التواصل والتفاعل الاجتماعي تحديًا. إن كنت تبحث عن طريقة تجعل التواصل أسهل وأقل توترًا، فإن منهج Berard AIT مصمم لإعادة التوازن وإعادة تدريب الوظائف السمعية حتى يصبح النظام السمعي أكثر كفاءة في معالجة الصوت. يوفر Berard AIT نوعًا محددًا وجديدًا من التحفيز بدرجات تردد وشدة ومدة مناسبة لإحداث التغيير. اللدونة العصبية هي قدرة الدماغ الطبيعية على إعادة تشكيل نفسه. يعيد Berard AIT تأهيل النظام ليكوّن مسارًا سلسًا وفعالًا لمدخلات السمع.',
      benefits: [
        'تحسن وضوح معالجة الأصوات',
        'فهم أفضل للكلام',
        'انخفاض حساسية الصوت',
        'مهارات تواصل أفضل',
      ],
  ...
  },
  {
    ...
    contentAr: {
      title: 'تطور اللغة',
      subtitle: 'لبنات التواصل الأساسية',
      questions: [
        'هل يصعب عليك فهم المحادثة في الأماكن المزدحمة؟',
        'هل واجهت صعوبة في صياغة أفكارك بالكلمات، أو شعرت أن ما قلته لا يعبّر عما أردت؟',
        'هل تعرف طفلًا لديه تأخر لغوي أو صعوبة في التواصل؟',
        'ربما تعرف شخصًا لديه مشاكل في النطق أو مخارج الحروف؟',
        'هل تواجه صعوبة في تعلم لغة ثانية؟ أو ترغب في تقليل اللكنة؟',
      ],
      explanation: 'تأخر اللغة أو صعوباتها تسبب إحباطًا وقلقًا وتحديات سلوكية وتؤثر في النمو الاجتماعي والأكاديمي. طريقة Berard AIT موثقة لقدرتها على إعادة تدريب المعالجة السمعية، كما تحفّز مراكز اللغة تحديدًا، مما يحسن تطوير اللغة أو تعلم لغات جديدة بسهولة أكبر. يجب أن تصبح قدرتنا على تمييز الأصوات تلقائية حتى تتحول الأصوات إلى كلمات. يعمل Berard AIT على أتمتة هذه العملية لتُنظَّم الأفكار وتُسلسَل إلى لغة تعبيرية تمثل ما نريد قوله فعلاً.',
      benefits: [
        'وضوح أفضل للكلام',
        'فهم لغوي أعلى',
        'تطوير مفردات أغنى',
        'تعلّم أسهل للغة ثانية',
      ],
    },
  ...
  },
  {
    ...
    contentAr: {
      title: 'التوازن والتنسيق',
      subtitle: 'تناغم جسدي وتحكم حركي',
      questions: [
        'هل حاولت تعلم ركوب الدراجة أو ممارسة رياضة أو الرقص وشعرت بالإحباط؟',
        'هل حاولت تعلم حرفة أو مهارة أو الكتابة بخط منسق وشعرت بالفشل؟',
        'هل تشعر بأنك غير متناسق الحركات أو أن لديك قدمين يسرى؟',
        'هل يؤثر ضعف التوازن أو الخوف من السقوط على سلامتك وحركتك؟',
        'هل أنت أو من تعرفه تتجنب أنشطة تتطلب التوازن والتنسيق؟',
      ],
      explanation: 'اكتشف Berard AIT كطريقة لتحسين التوازن والتنسيق لتحقيق الأهداف أو تعزيز الحركة والسلامة في الحياة اليومية. يتطلب التوازن والتنسيق تكامل عدة وظائف تعمل معًا. ينظم الجهاز الدهليزي داخل الأذن العديد من وظائف التوازن والحركة. يقدم Berard AIT تحفيزًا اهتزازيًا محددًا لإعادة تدريب نظام غير متوازن. كما يندمج النظامان السمعي والبصري لتصبح الوظيفة أكثر كفاءة. ومع تطور الوعي بالجسم، يتحسن تنسيق العضلات وتسلسل الحركة، ويزداد الشعور بالثقة والاستعداد للممارسة.',
      benefits: [
        'تحسن التنسيق الحركي',
        'وعي مكاني أفضل',
        'ثقة بدنية أعلى',
  ...
  },
  {
    ...
    contentAr: {
      title: 'العافية والرفاه',
      subtitle: 'الصحة النفسية والعاطفية العامة',
      questions: [
        'هل تشعر بالإحباط أو بخيبة الأمل تجاه نفسك؟',
        'هل لا تحقق الأهداف والخطط التي تحلم بها؟',
        'هل تشعر أن تجربة شيء جديد بلا جدوى لأنك فشلت في أنشطة مشابهة؟',
        'هل تفتقر للدافعية لأن الأمور تبدو صعبة النجاح؟',
      ],
      explanation: 'يبلغ كثيرون بعد إكمال Berard AIT أنهم أصبحوا أكثر دافعية وتنظيمًا ورضًا. وهي طريقة موثقة لتحسين المعالجة السمعية والحسية. السلوكيات التعويضية لمشكلات المعالجة تصبح أقل حاجة، ويعمل الدماغ والجسم بسلاسة أكبر، وتصبح المهارات الجديدة أسهل للتعلّم. تتحسن الذاكرة ويقل التوتر، ويزداد الشعور بالثقة والإيجابية نتيجة لهذه التغييرات.',
      benefits: [
        'زيادة الدافعية',
        'تنظيم عاطفي أفضل',
        'ثقة بالنفس أعلى',
  ...
  },
  {
    ...
    contentAr: {
      title: 'إدراك الموسيقى',
      subtitle: 'لغة الصوت العالمية',
      questions: [
        'تُعد الموسيقى لغة عالمية، لكنها لا تأتي بسهولة للجميع.',
        'هل تواجه صعوبة في إدراك فروق النغمة؟ أو تغني خارج السلم الموسيقي؟',
        'هل واجهت صعوبة في تعلم آلة موسيقية دون نجاح يُذكر؟',
        'أو هل تريد إثراء تجربة الاستماع أو العزف؟',
      ],
      explanation: 'يمكن لـ Berard AIT تحسين إدراك فروق النغمة بدقة أكبر. ومن النتائج الموثقة تحسن المعالجة السمعية؛ الآلية نفسها التي تحسن إدراك أصوات الكلام تحسن إدراك النغمات الموسيقية، مما يمنح وضوحًا أعلى للصوت ويثري تجربة العزف أو الاستماع.',
      benefits: [
        'تمييز أفضل للنغمة',
        'تقدير موسيقي أعلى',
        'تعلم أسهل للآلات',
  ...
  },
  {
    ...
    contentAr: {
      title: 'تحسين الذاكرة',
      subtitle: 'تخزين المعلومات واسترجاعها',
      questions: [
        'الجميع ينسى أحيانًا، لكن هل بدأ النسيان يؤثر على حياتك؟',
        'هل تنسى أحداثًا أو معلومات مهمة؟',
        'هل تعتبر نفسك كثير النسيان؟ أو تم انتقادك بسبب ذلك؟',
        'هل تشعر بالإحباط بسبب النسيان؟',
      ],
      explanation: 'يساعد Berard AIT في تحسين الذاكرة عبر تعزيز الانتباه والمعالجة. لتتذكر شيئًا ما، يجب أن تنتبه للمعلومات حتى تُسجَّل بوضوح في الدماغ. عند ضعف الانتباه أو سهولة التشتت، يصعب التسجيل والاسترجاع. يعمل Berard AIT على تحسين التركيز وتوازن الأنظمة المسؤولة عن معالجة المعلومات ليعمل الدماغ بكفاءة دون جهد واعٍ، مما يسهل حفظ المعلومات واسترجاعها سريعًا.',
      benefits: [
        'تحسن الاحتفاظ بالمعلومات',
        'استرجاع أفضل',
  ...
  },
  {
    ...
    contentAr: {
      title: 'تنظيم السلوك',
      subtitle: 'إدارة الاستجابات وردود الفعل',
      questions: [
        'أحيانًا يظهر السلوك السلبي فجأة دون سبب واضح.',
        'العدوان المفاجئ، ضعف التعاون، الانهيارات الانفعالية، الانسحاب والقلق تولد توترًا وإرباكًا للمعنيين.',
      ],
      explanation: 'هل تبحث عن طريقة لمعالجة السلوكيات الصعبة؟ الوصول إلى السبب الجذري يؤدي إلى نتائج أفضل طويلة المدى. في كثير من الحالات يكون السلوك السلبي تعويضًا عن تجارب حسية غير متوازنة أو ضعف في معالجة المدخلات السمعية. عندما تعمل المعالجة الحسية والسمعية بشكل جيد، يصبح التكيف مع متطلبات الحياة أسهل. يعمل Berard AIT على إعادة توازن النظام السمعي وتنظيم المدخلات الحسية، مما يساعد على إدارة التغييرات والتفاعلات اليومية.',
      benefits: [
        'تحكم عاطفي أفضل',
  ...
  },
  {
    ...
    contentAr: {
      title: 'تعزيز التعلم',
      subtitle: 'اكتساب المعرفة والاحتفاظ بها',
      questions: [
        'هل واجهت صعوبة في التعلم في المدرسة أو العمل؟',
        'هل تجد الشروحات الشفهية أو المكتوبة صعبة المتابعة؟',
        'هل شعرت أنك لست ذكيًا بما يكفي للتعلم؟',
        'هل تعرف طفلًا يعاني في المدرسة؟',
      ],
      explanation: 'يعيد Berard AIT تدريب قدرات المعالجة في الدماغ ويجعل التعلم أسهل. التعلم ليس مسألة ذكاء بل عملية لاكتساب المعرفة أو تعديلها. عندما تؤثر مشكلات المعالجة السمعية والحسية على هذه العملية يصبح التعلم صعبًا. يعيد Berard AIT تنظيم نظام المعالجة، فتتكامل أنظمة الدماغ والجسم ويصبح التعلم والاحتفاظ بالمعلومات أكثر تنظيمًا.',
      benefits: [
        'فهم أفضل',
        'معالجة معلومات أكفأ',
        'تحسن الأداء الدراسي',
  ...
  },
  {
    ...
    contentAr: {
      ...
      subtitle: 'كيف نفسر المدخلات الحسية',
      questions: [
        'قد تكون البيئة الخارجية أو الداخلية شديدة أو مربكة أو مخيفة بسبب فرط التنبيه.',
        'تتعطل القدرة على معالجة المدخلات وضبط السلوك والمشاعر بشكل مناسب.',
        'قد يظهر العدوان أو الانسحاب أو التعلق كاستجابة تكيفية لهذا الاضطراب.',
      ],
      explanation: 'قد يبقى الانتباه في حالة تأهب دائم استعدادًا لتجربة مرهقة، وقد يصبح النظام مرهقًا لدرجة الانغلاق عن المدخلات. عندها قد لا تصل الإشارات الحسية بما يكفي لتحفّز استجابة مناسبة. يوفر Berard AIT طريقة فعّالة لإعادة تنظيم النظام الحسي باستخدام تحفيز محدد في التردد والشدة والمدة، ما يسمح بتنظيم المدخلات ودمجها بشكل طبيعي، ويؤدي إلى استجابات أكثر هدوءًا وتوازنًا.',
      benefits: [
        'تكامل حسي أفضل',
        'تقليل فرط التحسس',
        'تكيف بيئي أفضل',
        'استجابات أكثر هدوءًا',
      ],
    },
