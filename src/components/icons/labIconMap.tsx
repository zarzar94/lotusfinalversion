...
const EMOJI_SAVE = '\u{1F4BE}';
const EMOJI_RULER = '\u{1F4D0}';
const EMOJI_MUSCLE = '\u{1F4AA}';
const EMOJI_SEEDLING = '\u{1F331}';
const EMOJI_LADDER = '\u{1FA9C}';
const EMOJI_BOLT = '\u{26A1}';
const EMOJI_GIFT = '\u{1F381}';
const EMOJI_SWORDS = '\u{2694}\u{FE0F}';
const EMOJI_SUPERHERO = '\u{1F9B8}';
const EMOJI_FOG = '\u{1F32B}\u{FE0F}';
const EMOJI_NEW_MOON = '\u{1F311}';
const EMOJI_CRYSTAL_BALL = '\u{1F52E}';
const EMOJI_SLIDER = '\u{1F39A}\u{FE0F}';
const EMOJI_MEMO = '\u{1F4DD}';
const EMOJI_PIANO = '\u{1F3B9}';
const EMOJI_NUMBERS = '\u{1F522}';
const EMOJI_MASKS = '\u{1F3AD}';
const EMOJI_100 = '\u{1F4AF}';
const EMOJI_SHIELD = '\u{1F6E1}\u{FE0F}';
const EMOJI_GEAR = '\u{2699}\u{FE0F}';
const EMOJI_WRENCH = '\u{1F527}';
const EMOJI_BELL = '\u{1F514}';
const EMOJI_BELL_SILENT = '\u{1F515}';
...
const EMOJI_TEACHER = '\u{1F469}\u{200D}\u{1F3EB}';
const EMOJI_PERSON = '\u{1F464}';
const EMOJI_WOMAN = '\u{1F469}';
const EMOJI_MAN = '\u{1F468}';
const EMOJI_OLDER_WOMAN = '\u{1F475}';
...
const emojiIconMap: Record<string, (props: IconProps) => JSX.Element> = {
  ...
  [EMOJI_SAVE]: (props) => <DownloadIcon {...props} />,
  [EMOJI_RULER]: (props) => <ChartIcon {...props} />,
  [EMOJI_MUSCLE]: (props) => <FlameIcon {...props} />,
  [EMOJI_SEEDLING]: (props) => <SparklesIcon {...props} />,
  [EMOJI_LADDER]: (props) => <ChartIcon {...props} />,
  [EMOJI_BOLT]: (props) => <RocketIcon {...props} />,
  [EMOJI_GIFT]: (props) => <SparklesIcon {...props} />,
  [EMOJI_SWORDS]: (props) => <TrophyIcon {...props} />,
  [EMOJI_SUPERHERO]: (props) => <ShieldMedicalIcon {...props} />,
  [EMOJI_FOG]: (props) => <SpectrogramIcon {...props} />,
  [EMOJI_NEW_MOON]: (props) => <SpectrogramIcon {...props} />,
  [EMOJI_CRYSTAL_BALL]: (props) => <SparklesIcon {...props} />,
  [EMOJI_SLIDER]: (props) => <SettingsIcon {...props} />,
  [EMOJI_MEMO]: (props) => <ChecklistIcon {...props} />,
  [EMOJI_PIANO]: (props) => <WaveformIcon {...props} />,
  [EMOJI_NUMBERS]: (props) => <ChartIcon {...props} />,
  [EMOJI_MASKS]: (props) => <SparklesIcon {...props} />,
  [EMOJI_100]: (props) => <CheckCircleIcon {...props} />,
  ...
  [EMOJI_BELL_SILENT]: (props) => <BellIcon {...props} />,
  ...
  [EMOJI_ALARM]: (props) => <CalendarIcon {...props} />,
  ...
  [EMOJI_TEACHER]: (props) => <SchoolIcon {...props} />,
  [EMOJI_PERSON]: (props) => <UserIcon {...props} />,
  [EMOJI_WOMAN]: (props) => <UserIcon {...props} />,
  [EMOJI_MAN]: (props) => <UserIcon {...props} />,
  [EMOJI_OLDER_WOMAN]: (props) => <UserIcon {...props} />,
  ...
  [EMOJI_POINT_UP]: (props) => <TargetIcon {...props} />,
