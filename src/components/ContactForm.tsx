...
import { brandCyan, brandPurple, brandColors, colors, devicePalette } from './styles';
...
const dynamicIslandStyle: React.CSSProperties = {
  ...
  width: 126,
  height: 37,
  background: devicePalette.black,
  borderRadius: 22,
  display: 'flex',
  alignItems: 'center',
...
const cameraDotStyle: React.CSSProperties = {
  ...
  height: 12,
  borderRadius: '50%',
  background: devicePalette.cameraGradient,
  border: `1px solid ${devicePalette.cameraBorder}`,
};
...
const iosScrollCss = `
  ...
  @keyframes iphoneGlow {
    0%, 100% { box-shadow: 0 0 0 2px ${devicePalette.frameOutline}, 0 50px 100px rgba(0,0,0,0.5), inset 0 0 30px rgba(255,255,255,0.02), 0 0 40px ${brandCyan}15; }
    50% { box-shadow: 0 0 0 2px ${devicePalette.frameOutline}, 0 50px 100px rgba(0,0,0,0.5), inset 0 0 30px rgba(255,255,255,0.02), 0 0 60px ${brandCyan}25; }
  }
  ...
  <div style={statusBarStyle}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
      <svg width="17" height="12" viewBox="0 0 17 12" fill="none">
        <rect x="0" y="8" width="3" height="4" rx="1" fill={colors.text.primary} />
        <rect x="4.5" y="5" width="3" height="7" rx="1" fill={colors.text.primary} />
        <rect x="9" y="2" width="3" height="10" rx="1" fill={colors.text.primary} />
        <rect x="13.5" y="0" width="3" height="12" rx="1" fill={colors.text.primary} />
      </svg>
      <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
        <path d="M8 3C10.8 3 13.3 4.1 15 6L13.5 7.5C12.2 6.2 10.2 5.3 8 5.3C5.8 5.3 3.8 6.2 2.5 7.5L1 6C2.7 4.1 5.2 3 8 3Z" fill={colors.text.primary}/>
        <path d="M8 6.5C9.9 6.5 11.6 7.2 12.8 8.4L11.3 9.9C10.5 9.1 9.3 8.6 8 8.6C6.7 8.6 5.5 9.1 4.7 9.9L3.2 8.4C4.4 7.2 6.1 6.5 8 6.5Z" fill={colors.text.primary}/>
        <circle cx="8" cy="11" r="1.5" fill={colors.text.primary}/>
      </svg>
...
const PhoneIcon = memo(() => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill={colors.text.primary}>
...
const InstagramIcon = memo(() => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill={colors.text.primary}>
...
const LinkedInIcon = memo(() => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill={colors.text.primary}>
...
const ContactForm = () => {
  ...
  const iPhoneFrameStyle = useMemo<React.CSSProperties>(() => ({
    ...
    aspectRatio: '390/844',
    minHeight: 640,
    background: devicePalette.frameGradient,
    borderRadius: 55,
    border: `8px solid ${devicePalette.frameBorder}`,
    boxShadow: `0 0 0 2px ${devicePalette.frameOutline}, 0 50px 100px rgba(0,0,0,0.5), inset 0 0 30px rgba(255,255,255,0.02)`,
    position: 'relative',
    overflow: 'hidden',
  }), []);
  ...
  const screenStyle = useMemo<React.CSSProperties>(() => ({
    ...
    background: submitted
      ? devicePalette.screenGradientSubmitted
      : devicePalette.screenGradientDefault,
  }), [submitted]);
  ...
  const submitButtonStyle = useMemo<React.CSSProperties>(() => ({
    ...
    color: requiredValid ? colors.text.primary : colors.text.disabled,
    fontSize: 17,
    fontWeight: 600,
          ...
          {submitted ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', height: 'calc(100% - 50px)', padding: '60px 20px 40px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  <h3 style={{ margin: '0 0 4px', fontSize: 28, fontWeight: 400, color: colors.text.primary }}>Berard AIT</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100% - 50px)', position: 'relative' }}>
              ...
              >
                ...
                <div style={{
                  ...
                  right: 0,
                  height: 20,
                  background: devicePalette.screenTopFade,
                  marginTop: -20,
                  marginBottom: 4,
                  pointerEvents: 'none',
                  zIndex: 2,
                ...
                <div style={{
                  ...
                  position: 'sticky',
                  bottom: 0,
                  background: devicePalette.screenBottomFade,
                  paddingTop: 16,
                  paddingBottom: 8,
                  marginBottom: -16,
                }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', height: 'calc(100% - 50px)', padding: '60px 20px 40px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  <h3 style={{ margin: '0 0 4px', fontSize: 26, fontWeight: 400, color: colors.text.primary }}>Berard AIT</h3>
              ...
              <div style={{ display: 'flex', gap: 16 }}>
                <a href={CLINIC.socials.instagram} target="_blank" rel="noreferrer" style={{ width: 44, height: 44, borderRadius: '50%', background: devicePalette.instagramGradient, display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
                  <InstagramIcon />
                </a>
