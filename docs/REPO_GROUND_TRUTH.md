...
> ملاحظة: تم إصلاح ‎`tsconfig.json`‎ لإزالة تكرار ‎`include`‎ ولإقصاء ملف ضبط Vitest من الفحص؛ يمكن إعادة تمكينه بعد توحيد إصدارات Vite/Vitest أو ترقية Vitest ليتطابق مع Vite 7.
